//
//  SearchGamesToAddTableViewController.swift
...
class SearchGamesToAddTableViewController: UITableViewController, XMLParserDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "gameSearchCell", for: indexPath) as! AddingGamesTableViewCell
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "fromSearchtoGameInfo" {
            
            if let vc = segue.destination as? AddGamesViewController {
                let cell = sender as! AddingGamesTableViewCell
                vc.gameID = cell.gameID
                vc.currUser = currUser
                
                print("gameID in prepare(): " + cell.gameID)
            }
        }
    }
